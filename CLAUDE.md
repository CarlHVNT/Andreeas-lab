...
| Qualifications, continuing education, specialisations (icon, title, paragraph) | `site.config.ts` → `practitioner`; rows rendered by `SpecialisationList.astro` as drop-downs, no links out |
